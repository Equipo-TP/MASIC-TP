      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-1/2">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="mb-4">
          <h3 className="text-lg font-bold mb-2">Agregar nueva incidencia</h3>
          <div className="grid grid-cols-3 gap-4">
          <select
              value={nuevaIncidencia.afectado}
              onChange={(e) => handleInputChange('afectado', e.target.value)}
              className="p-2 border rounded w-64 h-12 text-lg"
            >
