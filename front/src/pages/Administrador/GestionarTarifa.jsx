...
const GestionarTarifas = () => {
  ...
  const itemsPerPage = 5; // Máximo de tarifas por página
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          <div className="relative overflow-hidden sm:rounded-lg">
            ...
            <div className="max-h-80 overflow-y-auto shadow-md w-full text-sm text-left text-gray-500 dark:text-gray-400">
              <table className="w-full">
                ...
                <tbody>
                  {currentTarifas.map((tarifa, index) => (
                    <tr key={tarifa._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
